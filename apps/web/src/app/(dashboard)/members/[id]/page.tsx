...
import { Phone, MapPin, IdCard, Printer } from 'lucide-react';
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="space-y-6 lg:col-span-2">
            <GroupCard icon={IdCard} title="Membership Information">
              ...
              <DetailRow label="Date Joined" value={new Date(member.dateJoined).toLocaleDateString()} />
            </GroupCard>

            <GroupCard icon={Phone} title="Contact Information">
            ...
            <GroupCard icon={MapPin} title="Organizational Location">
